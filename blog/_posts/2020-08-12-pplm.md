...
---
[click for html version](https://imedkrisna.github.io/blog/pplm.html)
...
$$
Trade_ij=\frac{GDP_{i}*GDP_{j}}{Distance_{ij}} \label{1}
$$

That is, the amount of bilateral trade made by two countries is related to their economic size (mass in the normal gravity equation) and their distance, as a proxy for trade cost. Obviously these days there are many extension to this model, but I won't dwell on it for now. For now, let's focus on the PPLM extension.
